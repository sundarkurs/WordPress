...
<section
      ...
      <div class="home-content">
        <div class="row contents">
          <div class="home-content-left">
            <h3 >Welcome to Swayam consultants</h3>

            <h1 data-aos="fade-up">
              Real Estate Without the Hassle. <br />
          ...
          <div class="home-image-right">
            <img
              src="<?php echo get_theme_file_uri('/images/iphone-app-470.png') ?>"
              srcset="
              <?php echo get_theme_file_uri('/images/iphone-app-470.png') ?>,
              <?php echo get_theme_file_uri('images/iphone-app-940.png 2x') ?>
              "
              data-aos="fade-up"
            />
          </div>
    ...
    <section id="about">
      ...
      <div class="row about-bottom-image">
        <img
          src="<?php echo get_theme_file_uri('/images/app-screens-1200.png') ?>"
          srcset="
          <?php echo get_theme_file_uri('/images/app-screens-600.png 600w') ?>,
          <?php echo get_theme_file_uri('/images/app-screens-1200.png 1200w') ?>,
          <?php echo get_theme_file_uri('/images/app-screens-2800.png 2800w') ?>
          "
    ...
    <section id="pricing">
      <div class="row pricing-content">
        <div class="col-four pricing-intro">
          <h1 class="intro-header" data-aos="fade-up">Featured Projects</h1>
          ...
          <div class="slides owl-carousel">
            <div>
              ...
              <div class="testimonial-author">
                <img src="<?php echo get_theme_file_uri('images/avatars/user-02.jpg') ?>" alt="Author image" />
            ...
            <div>
              ...
              <div class="testimonial-author">
                <img src="<?php echo get_theme_file_uri('images/avatars/user-03.jpg') ?>" alt="Author image" />
                <div class="author-info">
                  Random One
